-- On-Demand guardrails: RPC validation + lectura publica del flag operativo
...
drop policy if exists "business_settings_select_active_business_public" on public.business_settings;
