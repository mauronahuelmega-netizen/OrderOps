  ...
  return (
    <section className="admin-form-card super-admin-route-section">
      <div className="admin-form-header">
        <h2>Negocios</h2>
        <p>Gestioná negocios existentes sin sobrecargar la vista principal.</p>
      </div>
      ...
      {businesses.length > 0 ? (
        ...
        <div className="admin-empty-state">
          <h2>No hay negocios todavía</h2>
          <p>Creá el primer cliente desde la vista principal de super admin.</p>
        </div>
      )}
    </section>
  );
