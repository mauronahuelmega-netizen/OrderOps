...
export default function EditProductForm({
  ...
  return (
    <form
      action={formAction}
      className={inModal ? "admin-product-form admin-product-form-shell" : "admin-product-card admin-product-form-shell"}
    >
      ...
      <div className="admin-product-fields">
        ...
        <p className="admin-product-category">
          Categoría actual: <strong>{product.categories?.name ?? "Sin categoría"}</strong>
        </p>

        <label className="ui-field">
          <span className="ui-label">Descripción</span>
          <textarea
            className="ui-input admin-product-textarea"
            name="description"
            rows={4}
