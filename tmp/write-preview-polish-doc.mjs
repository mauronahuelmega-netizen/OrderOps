...
const content = `# PRODUCT-CUSTOMIZATION-ADMIN-PREVIEW-POLISH-1 — Interactive Admin Preview Sandbox
...
fs.writeFileSync(
  "docs/product-customization-admin-preview-polish-1-interactive-preview-sandbox.md",
  content,
  "utf8"
);
console.log("DOC_OK");
